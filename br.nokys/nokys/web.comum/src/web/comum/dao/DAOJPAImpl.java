 ...
 * deve possuir uma implementação DAO que extende esta classe e implementar uma
 * interface DAO referente a Entidade.
 * 
 ...
 */
 public abstract class DAOJPAImpl<T, K> implements IDAO<T, K> {
