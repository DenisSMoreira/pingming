...
/**
 * Importe da classe java. util.Date
 */

import java.util.Date;

/**
 * . Bean referente ao relatorio Conta acesso
 * 
 */
public class ContaAcesso implements java.io.Serializable {
