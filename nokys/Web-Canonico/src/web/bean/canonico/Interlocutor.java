...
public class Interlocutor implements java.io.Serializable {
	 ...
	 * @return the exlusao
	 */
	public Boolean getExlusao() {
		return exlusao;
	}

	/**
	 * @param exlusao the exlusao to set
	 */
	public void setExlusao(Boolean exlusao) {
		this.exlusao = exlusao;
	}
	...
	public void setAbrangencias(List<Abrangencia> abrangencias) {
		this.abrangencias = abrangencias;
	}
