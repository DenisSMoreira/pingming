 ...
 */
package web.comum.util.excpetion;
 ...
 * Erro base do site.
 * <br>
 * Classe permite identificar erros que pertencem ao site e erros que foram gerados pelo sistema.
 * <BR><BR>
 * Data de Criação: 01/07/2011<br>
...
public class BaseException extends Exception {
    ...
    public void printStackTrace() {
        ...
        System.err.println("C\363digo: " + codigo + " - " + "Local : " + local);
        if (cause != null) {
     ...
     * @param printwriter objeto de escrita que será utilizado durante impressão.
     */
    public void printStackTrace(PrintWriter printwriter) {
        super.printStackTrace(printwriter);
        printwriter.println("C\363digo: " + codigo + " - " + "Local : " + local);
        if (cause != null) {
     ...
     * @return Throwable objeto de erro original que justificou a criação desta exception.
     */
